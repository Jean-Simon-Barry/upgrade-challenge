...
public class AvailabilityServiceTest {
  ...
  public void getAvailableDatesWhenNoReservations() {
    ...
    //when
    List<LocalDate> availableDates = availabilityService
        .findAvailabilities(new DateInterval(now, tenDaysFromNow),
            emptyList());
  ...
  public void getAvailableDatesWhenMultipleReservationsInTheMiddleOfRequestedInterval() {
    ...
    List<LocalDate> secondChunk = firstReservationEnd.datesUntil(secondReservationStart)
        .collect(toList());
